            ...
            <div class="card" style="text-align: center; padding: 10px 8px 13px 8px; width: 97%; margin-left: 14px; margin-bottom: 0px;">
                 <table class="table table-hover" style="text-align: left; margin-left: 5%; width: 90%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:ListBox ID="lstDistricts" runat="server" AutoPostBack="true" style="height:130px !important;" SelectionMode="Multiple" OnSelectedIndexChanged="lstDistricts_SelectedIndexChanged"></asp:ListBox></td>
                                      
                                    
                                    <td>
                                        <asp:ListBox ID="lstSurveyTeam" runat="server" AutoPostBack="true" style="height:130px !important;" SelectionMode="Multiple" OnSelectedIndexChanged="lstSurveyTeam_SelectedIndexChanged" ></asp:ListBox>
                                    </td>
                                    <td>
                                        <asp:ListBox ID="lstEnumerator" runat="server" AutoPostBack="true" style="height:130px !important;" SelectionMode="Multiple" OnSelectedIndexChanged="lstEnumerator_SelectedIndexChanged" ></asp:ListBox></td>
                                     </tr>
