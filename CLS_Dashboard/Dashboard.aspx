...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div>
                ...
                <div class="col-md-">
                        <div class="card" id="container4Listing"></div>
                    </div>
                ...
                <div class="row" style="width: 100%; margin-left: 0px;">
                    ...
                    <div class="col-md-12">
                     ...
                     <div class="col-md-12">
                        ...
                        <div class="card" id="container22"></div>
                    </div>
                     <div class="col-md-12">

                        <div class="card" id="container222"></div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card" id="container77" style="margin-top: 0px;"></div>
                    </div>
                    <div class="col-md-12">
                        <div class="card" id="container8" style="margin-top: 0px;"></div>
                    </div>
                       <div class="col-md-12">
                        <div class="card" id="container88" style="margin-top: 0px;"></div>
                    </div>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        Highcharts.chart('container2', {
                            ...
                            subtitle: {
                              text: 'Source: Supervisors app + Main'  
                            },
    ...
    <script type="text/javascript">
        function UpdateChart23() {
            var title14 = '<%= chartTitle21 %>';
            ...
            $(function () {
                ...
                $.ajax({
                    ...
                    cache: false,
                    url: "Dashboard.aspx/getChartData231",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
                        ...
                        Highcharts.chart('container22', {
                            ...
                            series: [ <%= chart_SurveyProgress_ClusterLevel11 %> ]
        ...
        function UpdateChart22() {
            ...
            $(function () {
                ...
                $.ajax({
                    ...
                    cache: false,
                    url: "Dashboard.aspx/getChartData2311",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
                        ...
                        Highcharts.chart('container222', {
                            ...
                            xAxis: {
                                labels: { rotation: 10, y: 30, staggerLines: 1 },
                                categories: ['Cluster to be Revisited'],
                            ...
                            series: [ <%= chart_SurveyProgress_ClusterLevel22 %> ]
  ...
  <script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        function UpdateChart88() {

            var title = '<%= chartTitle88 %>';
            ...
            $(function () {
                ...
                $.ajax({
                    ...
                    cache: false,
                    url: "Dashboard.aspx/getChartData88",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
    ...
    <script type="text/javascript">
        function UpdateChart77() {
            var title9 = '<%= chartTitle77 %>';
            ...
            $(function () {
                ...
                $.ajax({
                    ...
                    cache: false,
                    url: "Dashboard.aspx/getChartData77",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
    ...
    <script>
        ...
        ////////////Dashboard Run need tobe uncomment
