    ...
    public partial class SurveyProgress : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Session["lblHeadingName"] = "<b>SCLS</b>-Survey Progress";
        ...
        {
            if ((Report_ID == Report_1001) || (Report_ID == Report_1002) || (Report_ID == Report_1003)) { lstDistricts.Visible = false; lblDistricts.Visible = false;
                lstTypes.Visible = true; lblTypes.Visible = true;
            }
            if ((Report_ID == Report_1004) || (Report_ID == Report_1005) || (Report_ID == Report_1007) || (Report_ID == Report_1008))
            {
                lstDistricts.Visible = true; lblDistricts.Visible = true;
                lstEnumerator.Visible = true; lblEnumerator.Visible = true;
            }
            if ((Report_ID == Report_1006) || (Report_ID == Report_1009) || (Report_ID == Report_1010) || (Report_ID == Report_1021))
            {
                lstDistricts.Visible = false; lblDistricts.Visible = false;
                lstEnumerator.Visible = false; lblEnumerator.Visible = false;
            }
            if (Report_ID == Report_1 || Report_ID == Report_2 || Report_ID == Report_3 || Report_ID == Report_5 || Report_ID == Report_7 || Report_ID == Report_9 || Report_ID == Report_11 || Report_ID == Report_12 || Report_ID == Report_13 || Report_ID == Report_16 || Report_ID == Report_10 || Report_ID == Report_17) { lstSurveyTeam.Visible = true; lblSurveyTeam.Visible = true; }
            if (Report_ID == Report_2 || Report_ID == Report_5) { lstClusterCodes.Visible = true; lblClusterCode.Visible = true; }
            if (Report_ID == Report_3 || Report_ID == Report_6 || Report_ID == Report_8 || Report_ID == Report_11 || Report_ID == Report_12 || Report_ID == Report_13) { lstEnumerator.Visible = true; lblEnumerator.Visible = true; }
        ...
        private void gv_Bind_Data(string Filter_Data, string Report_ID, string Report_Name)
        {
            ...
            else if (Report_ID == Report_2)
            {
                ...
                query = "SELECT * FROM [Report2]" + Filter_Data;
            }

            else if (Report_ID == Report_3)
            {

                query = "SELECT * FROM [Report4]" + Filter_Data;
            }
            ...
            else if (Report_ID == Report_5)
            {
                ...
                query = "SELECT * FROM [Added_Report_New2]" + Filter_Data + "order by 2";
            }
            ...
            else if (Report_ID == Report_15)
            {
                ...
                query = "SELECT * FROM [Added_Report_New1]" + Filter_Data;
            }
            ...
            else if (Report_ID == Report_1004)
            {
                ...
                query = "SELECT * FROM [SummaryR]" + Filter_Data;
            }
            ...
            else if ((Report_ID == Report_1010) || (Report_ID == Report_1023))
            {
            ...
            else if (Report_ID == Report_1021)
            {
                ...
                query = "SELECT [Name of District],[Name Of Enumerator],[Name of Supervisor],[Others_Mistakes] FROM [Enumerator_Mistakes_Count]" + Filter_Data;
            }
            else if (Report_ID == Report_1001)
            {
                if (Filter_Data == "Tools")
                  query = "SELECT * FROM [Tools_Text_Review]";
            ...
            if (Report_ID == Report_1001 || Report_ID == Report_1002 || Report_ID == Report_1003 || Report_ID == Report_1004 || (Report_ID == Report_1005) || (Report_ID == Report_1006) || (Report_ID == Report_1007) || (Report_ID == Report_1008) || (Report_ID == Report_1009) || (Report_ID == Report_1010))
            {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                for (int j = 0; j < dt.Columns.Count; j++)
                {
                    ...
                    if (type == dt.Columns[j].DataType.Name.ToString())
                    {
                        ...
                        if (((count >= 3) && (Report_ID == Report_3)) || ((count == 3) && (Report_ID == Report_5)))
                        {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowIndex >= 0)
            {
                ...
                {
                    if (Convert.ToInt32(e.Row.Cells[12].Text) > 6)
                    {
                        e.Row.Cells[12].BackColor = System.Drawing.Color.Coral;
                    }

                    else if (Convert.ToInt32(e.Row.Cells[12].Text) == 0)
                    {
                    ...
                    lblLegendsText.Text = ulTagOpen + liRedTagOpen + "If the 'Final Balance’ is greater than 6" + liRedTagClose + liGreenTagOpen + "If the 'Final Balance’ is 0" + liGreenTagClose + liKhakiTagOpen + "1<=x<=6" + liKhakiTagClose + liBlackTagOpen + "HH tagging in wrong cluster" + liBlackClose + ulTagClose;
                ...
                else if (Report_ID == Report_7)
                {
                    ...
                    lblLegendsText.Text = lblLegendsText.Text + "<span style=' padding: 14px ; border: 1px solid #000; display: inline; float: left;margin-left: 5px;'>Total Collections" + ulTagOpen + liRedTagOpen + "Less than or equal to 10 hours" + liRedTagClose + ulTagClose + "&nbsp;&nbsp;&nbsp;&nbsp;</span>";
