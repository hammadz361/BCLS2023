                    ...
                    success: function (response) {
                        ...
                        Highcharts.chart('container2', {
                            ...
                            xAxis: {
                                ...
                                categories: ['Cluster Initiated', 'Cluster Completed', 'Cluster to be Revisited'],
            ...
            $(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        var Clusters_Initiated = eval(response.d[1]);
                        ...
                        Highcharts.chart('container7', {
                            ...
                            series: [{
                                ...
                                name: 'Clusters_Initiated',
                                data: Clusters_Initiated,
                                color: '#24E07C',
                                marker: {
                                    lineWidth: 2,
                                ...
                                type: 'column',
                                name: 'Clusters_In_Progress',
                                color: '#FFCC00',
                                data: Clusters_In_Progress

                            }, {
                                type: 'column',
                                name: 'Cluster Completed',
                                color: '#FF9900',
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        Highcharts.chart('container8', {
                            ...
                            series: [{
                                name: 'Cluster Completed Percentage',
                                color: 'orange',
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        Highcharts.chart('container10', {
                            ...
                            subtitle: {
                                text: 'Please note: The graphs presented below intend to show the number of working children and do not provide estimations of child labour'
                            },
                            xAxis: {
                                categories: District,
                                title: {
