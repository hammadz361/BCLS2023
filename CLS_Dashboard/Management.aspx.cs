    ...
    public partial class Management : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Session["lblHeadingName"] = "<b>" + Session["reg"] + "</b>-Admin Panel";
        ...
        private void LoadDataDrop()
        {
            ...
            ddSupervisors.DataSource = GetData("select distinct case when  G3_Supervisor_1_code is not null then G3_Supervisor_1_code  end As Supervisor_code, case when  G3_Supervisor_1 is not null then G3_Supervisor_1  end As Supervisor_Name from main");
        ...
        protected void GridView3_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            DateTime dateTime10 = Convert.ToDateTime(CreateDate);

            string s = dateTime10.ToString("MM/dd/yyyy HH:mm:ss tt");
            //TextBox textadd = (TextBox)row.FindControl("txtadd");  
            //TextBox textc = (TextBox)row.FindControl("txtc");  
            GridView3.EditIndex = -1;
            con.Open();
            //SqlCommand cmd = new SqlCommand("SELECT * FROM detail", con);  
            SqlCommand cmd = new SqlCommand("update Users set Username='" + Username + "',Role='" + Role + "',Assign='" + Assign + "',Email='" + Email + "',CreatedDate='" + s + "' where UserId=" + userid + "");
            cmd.Connection = con;
