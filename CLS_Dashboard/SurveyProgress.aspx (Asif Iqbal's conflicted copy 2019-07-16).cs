    ...
    public partial class SurveyProgress : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Session["lblHeadingName"] = "<b>KPCLS</b>-Survey Progress";
        ...
        {
            if ((Report_ID == Report_1002) || (Report_ID == Report_1023) || (Report_ID == Report_1003) || (Report_ID == Report_1021) || (Report_ID == Report_1010) || (Report_ID == Report_1022)) { lstDistricts.Visible = false; lblDistricts.Visible = false;
            ...
            if ((Report_ID == Report_1001) || (Report_ID == Report_1020) || (Report_ID == Report_1006) || (Report_ID == Report_1009) || (Report_ID == Report_1010))
            {
        ...
        private void gv_Bind_Data(string Filter_Data, string Report_ID, string Report_Name)
        {
            ...
            {
                query = "SELECT * FROM [Report1]" + Filter_Data + " order by 1";
            ...
            else if (Report_ID == Report_2)
            {
                query = @"SELECT [Name of District]
                        ...
                        ,[Number of HHs Interviewed] FROM [Report2]" + Filter_Data;
                Data_Source.Text = "Data Source: Interviewers submissions<br>";
                Data_Source.Visible = true;
            }
            else if (Report_ID == Report_21)
            {
                query = "SELECT * FROM [Report2B]" + Filter_Data ;
                Data_Source.Text = "Data Source: Supervisors app<br>";
                Data_Source.Visible = true;
            }
      ...
      ,[Maximum Number Of Children]
        FROM [Report4]" + Filter_Data;
            ...
            else if (Report_ID == Report_4)
            {
                ...
                query = "SELECT * FROM [Report1_District]" + Filter_Data;
            }

            else if (Report_ID == Report_5)
            {

                query = "SELECT [Name of District],[Team Supervisor],[Cluster Code],[Target HHs],[HHs Interviewed] as [HHs Submitted] ,[Percent Covered],[No. of Children as per Listing],[No. of Children as per HH Interview (Roster)],[No. of Children Interviewed],[Percent of children interviewd over roster] as [% of children interviewed over roster I/H],[%children listed vs. children roster] as [% of children in roster over children listed H/G] FROM [Added_Report_New2]" + Filter_Data + "order by 2";
            }

            else if (Report_ID == Report_6)
            {

                query = "SELECT * FROM [Added_Report_New3]" + Filter_Data;
            }
            ...
            else if (Report_ID == Report_7)
            {
                ...
                query = "SELECT * FROM [Supervisor_Hr_In_Field]" + Filter_Data;
            }

            else if (Report_ID == Report_8)
            {

                query = "SELECT * FROM [Monitoring_Of_Enumerator]" + Filter_Data;
            }

            else if (Report_ID == Report_9)
            {

                query = "SELECT * FROM [Monitoring_Of_Supervisors]" + Filter_Data;
            }

            else if (Report_ID == Report_10)
            {

                query = "SELECT * FROM [Monitoring_Of_Observers]" + Filter_Data;
            }

            else if (Report_ID == Report_11)
            {

                query = "SELECT * FROM [Observers_Report_Affirmatives]" + Filter_Data;
            }

            else if (Report_ID == Report_12)
            {

                query = "SELECT * FROM [Observers_Report_WeightedIssues]" + Filter_Data;
            }

            else if (Report_ID == Report_13)
            {

                query = "SELECT * FROM [Observers_Report_Absolute_Issues_Percent]" + Filter_Data;
            }

            else if (Report_ID == Report_14)
            {

                query = "SELECT * FROM [Report3]" + Filter_Data;
            }
      ...
      ,[Projected completion date (Bos)]
        FROM [Added_Report_New1]" + Filter_Data;
            ...
            {
                query = "SELECT * FROM [Progress_of_field_monitor]" + Filter_Data;
            }
            else if (Report_ID == Report_1023)
            {
                if (Request["type"] == "100")
                {
                    query = "SELECT * FROM [Summary_Progress_Monitor]";
                }
                else if (Request["type"] == "101")
                {
                    query = "SELECT * FROM [Summary_Progress_Supervisor]";
                }
                else if (Request["type"] == "102")
                {
                    query = "SELECT * FROM [Summary_Progress_Operator]";
                }
            }
            else if (Report_ID == Report_17)
            {
                query = "SELECT * FROM [Progress_of_observers]" + Filter_Data;
            }
            else if (Report_ID == Report_1004)
            {
                ...
                try
                {
                    ...
                    {
                        filter = "where [Supervisor Code] in ( select [Supervisor_ID] from Supervisor where DeskMonitor_ID = '" + Session["Profile_ID"] + "') ";
                    }
                }
                catch (Exception)
                {
                ...
                {
                    filter = "where [Supervisor Code] in ( select [Supervisor_ID] from Supervisor where DeskMonitor_ID in ( select Monitor_ID from DeskMonitors where Operator_ID = '" + Session["Profile_ID"] + "')) ";
                ...
                if (Filter_Data == " ")
                {
                    if(Request["Type"]=="Corrected")
                        query = "SELECT * FROM [SummaryR_Corrected] " + filter;
                    else if (Session["Role"].ToString().Contains("Supervisor"))
                        query = "SELECT * FROM [SummaryR_SupervisorFilter] " + filter;
                    else if (Session["Role"].ToString().Contains("DataValidator"))
                        query = "SELECT * FROM [SummaryR_ValidatorFilter] " + filter;
                    else
                        query = "SELECT * FROM [SummaryR] " + filter + "  order by SubmissionDate desc ";
                }
                else
                {
                     if (Request["Type"] == "Corrected")
                         query = "select * from (SELECT * FROM [SummaryR_Corrected] " + filter + ") as X " + Filter_Data;
                     else if (Session["Role"].ToString().Contains("Supervisor"))
                         query = "select * from (SELECT * FROM [SummaryR_SupervisorFilter] " + filter + ") as X " + Filter_Data;
                     else if (Session["Role"].ToString().Contains("DataValidator"))
                         query = "select * from (SELECT * FROM [SummaryR_ValidatorFilter] " + filter + ") as X " + Filter_Data;
                     else
                        query = "select * from (SELECT * FROM [SummaryR] " + filter + ") as X " + Filter_Data;
                }
            }
            else if(Report_ID == Report_10044)
            {
                ...
                {
                    if (Request["Type"] == "Corrected")
                        query = "SELECT [HouseHold Key] ,[Cluster Code],[Household ID],[Name of District],[Name Of Enumerator],[Enumerator Code],[Name of Supervisor],[Supervisor Code],[Monitor_Name],[Tehsil],[Section1],[Section2],[Section3],[Section5],[Section7],[Section8],[Section9],[Section10],[Section12],[Others] FROM [SummaryR_Corrected] ";
                    else
                        query = "SELECT [HouseHold Key] ,[Cluster Code],[Household ID],[Name of District],[Name Of Enumerator],[Enumerator Code],[Name of Supervisor],[Supervisor Code],[Monitor_Name],[Tehsil],[Section1],[Section2],[Section3],[Section5],[Section7],[Section8],[Section9],[Section10],[Section12],[Others] FROM [SummaryR] ";
                }
                else
                {
                    if (Request["Type"] == "Corrected")
                        query = "select [HouseHold Key] ,[Cluster Code],[Household ID],[Name of District],[Name Of Enumerator],[Enumerator Code],[Name of Supervisor],[Supervisor Code],[Monitor_Name],[Tehsil],[Section1],[Section2],[Section3],[Section5],[Section7],[Section8],[Section9],[Section10],[Section12],[Others] from (SELECT * FROM [SummaryR_Corrected] " + ") as X " + Filter_Data;
                    else
                        query = "select [HouseHold Key] ,[Cluster Code],[Household ID],[Name of District],[Name Of Enumerator],[Enumerator Code],[Name of Supervisor],[Supervisor Code],[Monitor_Name],[Tehsil],[Section1],[Section2],[Section3],[Section5],[Section7],[Section8],[Section9],[Section10],[Section12],[Others] from (SELECT * FROM [SummaryR] " + ") as X " + Filter_Data;
                }
            }
            else if (Report_ID == Report_1005)
            {

                query = "SELECT * FROM [Enumerator_Mistakes_Count]" + Filter_Data;
            }
            else if (Report_ID == Report_1006)
            {

                query = "SELECT * FROM [OutlierMistakes]" + Filter_Data;
            }
            else if (Report_ID == Report_1007)
            {

                query = "SELECT * FROM [Others_Percentage_FieldWise]" + Filter_Data;
            }
            else if (Report_ID == Report_1008)
            {

                query = "SELECT * FROM [Others_Question_percentage]" + Filter_Data;
            }
            ...
            if (Report_ID == Report_1001 || Report_ID == Report_10044 || Report_ID == Report_1002 || Report_ID == Report_1003 || Report_ID == Report_1004 || (Report_ID == Report_1005) || (Report_ID == Report_1006) || (Report_ID == Report_1007) || (Report_ID == Report_1008) || (Report_ID == Report_1009) || (Report_ID == Report_1010))
            {
        ...
        protected void performance()
        {
            ...
            string query = "select [Total Assigned],[Reviewed & Resolved] + [Reviewed & Closed] as [Resolved & Corrected] ,[Reviewed & Reassigned] from [Summary_Progress_Monitor] where Monitor_Name = ( SELECT [Username] FROM [GBCLS2018].[dbo].[users] where UserId =  '" + Session["UserID"] + "')";
            DataTable dt = new DataTable();
             SqlCommand cmd = new SqlCommand(query);
            cmd.Connection = con;
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                for (int j = 0; j < dt.Columns.Count; j++)
                {
                    ...
                    if (type == dt.Columns[j].DataType.Name.ToString())
                    {
                        ...
                        else if (columnName != "Average no. of children(5-17) in HH with at least 1 working child" && columnName != "Average Number of Interviews Per Day" && columnName!= "Average number of working children in HH with at least 1 working children")
                        {
                    ...
                    {
                        float Column_I = Convert.ToInt32(GridView1.FooterRow.Cells[6].Text.ToString());
                        float Column_H = Convert.ToInt32(GridView1.FooterRow.Cells[5].Text.ToString());
                        float Avg = (Column_I / Column_H)*100;
                    ...
                    {
                        float Column_H = Convert.ToInt32(GridView1.FooterRow.Cells[5].Text.ToString());
                        float Column_G = Convert.ToInt32(GridView1.FooterRow.Cells[4].Text.ToString());
                        float Avg = (Column_H / Column_G) * 100;
                        decimal m = Convert.ToDecimal(Avg);
                        decimal d = Math.Round(m, 2);
                        GridView1.FooterRow.Cells[count].Text = d.ToString();
                    }
                    ...
                    {
                        float Column_F = Convert.ToInt32(GridView1.FooterRow.Cells[4].Text.ToString());
                        float Column_C = Convert.ToInt32(GridView1.FooterRow.Cells[1].Text.ToString());
                        float Avg = (Column_F / Column_C) * 100;
                        decimal m = Convert.ToDecimal(Avg);
                        decimal d = Math.Round(m, 2);
                        GridView1.FooterRow.Cells[count].Text = d.ToString();
                    }
                    ...
                    {
                        float Column_D = Convert.ToInt32(GridView1.FooterRow.Cells[2].Text.ToString());
                        float Column_C = Convert.ToInt32(GridView1.FooterRow.Cells[1].Text.ToString());
                        float Avg = (Column_D / Column_C) * 100;
                        decimal m = Convert.ToDecimal(Avg);
                        decimal d = Math.Round(m, 2);
                        GridView1.FooterRow.Cells[count].Text = d.ToString();
                    }
                    ...
                    {
                        float Column_B = Convert.ToInt32(GridView1.FooterRow.Cells[1].Text.ToString());
                        float Column_C = Convert.ToInt32(GridView1.FooterRow.Cells[2].Text.ToString());
                        float Avg = (Column_C / Column_B) * 100;
                        decimal m = Convert.ToDecimal(Avg);
                        decimal d = Math.Round(m, 2);
                        GridView1.FooterRow.Cells[count].Text = d.ToString();
                    }
